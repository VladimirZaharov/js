...
let productsObj = document.querySelector('.products')
...
function showCategory(category) {
    ...
    catProd.forEach(function (product) {
        productIns += getProductMarkup(product)
    })
    productsObj.insertAdjacentHTML('afterbegin', productIns)
}
